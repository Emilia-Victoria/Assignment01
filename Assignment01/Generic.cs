...
This means that T, must either be or implement the interface IComparable, and moreover,
given the <T> at the end, T must be able to use the compareTo() method on an object of the same type T.
